...
async def send_follow_ups(chat_id: int, bot):
        try:
            ...
            keyboard = [[InlineKeyboardButton("Стартовый план", callback_data="consultation")]]
            reply_markup = InlineKeyboardMarkup(keyboard)
            await bot.send_message(
                chat_id=chat_id,
            ...
            await bot.send_message(
                ...
                text="🕰 Готовы собрать вашу семейную историю: архивы + красивый альбом.\n"
                     "Подбери сегодня стартовый пакет с 10% скидкой по промокод **PRO10** на http://rodoslovnaya.pro/"
            )
