...
async def handle_contact(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    extra_context = ""
if any(k in data['known'].lower() for k in ["плен", "репатри", "остарбайтер", "фильтрац", "проверка"]):
    extra_context = (
        "\n\nУчти, что для военнопленных и репатриированных нужно указывать конкретные архивы из файла 'фильтрация 20.06.2024.xlsx'. "
        "Например:\n"
        "- Государственный архив Мурманской области — фонд Р-140: фильтрационно-проверочные дела, списки репатриированных\n"
        "- УФСБ России по Саратовской области — фильтрационные дела бывших военнопленных (фонд № 6210)\n"
        "- Информационный центр УМВД по Архангельской области — журнал репатриированных граждан\n"
        "Указывай конкретный архив, фонд и тип документов."
    )
...
- С указанием **глубины источников**: метрические книги (до 1917), ревизские сказки (до 1858), исповедные ведомости (до 1880-х)
