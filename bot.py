...
async def handle_contact(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    - Этимологию (корень, язык происхождения)
    - Вероятную национальность (русская, татарская, украинская, польская и т.д.)
    - Географическое распространение (регионы, республики, страны)
    - Варианты написания (например: Шарапов → Шарафутдинов)
    - Связь с профессией, именем, титулом или местом
    - Рекомендации: где искать носителей этой фамилии (архивы, ЗАГСы, онлайн-ресурсы)
    - Какие документы могут содержать информацию (метрические книги, ревизские сказки и т.д.)
...
Ответ должен быть:
- Структурирован как: "📌 Исходные данные", "🔍 ПОШАГОВАЯ СТРАТЕГИЯ", "✅ Чек-лист"
...
1. **Анализ фамилии** — обязательно включи:
   - Этимологию, национальные и религиозные корни
   - Географическое распространение
   - Связь с профессией, именем, местом
   - Варианты написания
